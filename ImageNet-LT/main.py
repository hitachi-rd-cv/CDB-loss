...
parser.add_argument('--cfg', default='./config/ImageNet_LT/feat_uniform_with_CDBloss.yaml', type=str)
...
#parser.add_argument('--cdb_loss_tau', type=float, default=0)
...
def update(config, args):
    ...
    if args.knn and args.test:
        ...
        classifier = {
            'def_file': '/glusterfs/whale/dataset/ILSVRC2012/classifier-balancing-master/models/KNNClassifier.py',
            'params': classifier_param,
            'optim_params': config['networks']['classifier']['optim_params']}
        config['networks']['classifier'] = classifier
    #if args.cdb_loss_tau:
    #    config['criterions']['PerformanceLoss'] = {
    #                                           'def_file': 'loss/CDBSoftmaxLoss.py',
    #                                           'loss_params': {'tau': args.cdb_loss_tau, 'focal_gamma': args.focal_gamma, 'normalize': True},
    #                                           'optim_params': NULL,
    #                                           'weight': 1.0}
